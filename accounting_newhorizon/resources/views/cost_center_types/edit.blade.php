...
<main class="flex-1 p-8 overflow-y-auto">
    <header class="flex justify-between items-center mb-8 pb-4 border-b border-gray-200">
        <h1 class="text-3xl font-extrabold text-primary">
            <i class="fas fa-edit ml-3 text-secondary"></i> تعديل نوع مركز تكلفة
        </h1>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-2xl border-t-4 border-primary p-8">
            <form action="{{ route('cost-center-types.update', $costCenterType->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $costCenterType->code) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $costCenterType->name) }}"
